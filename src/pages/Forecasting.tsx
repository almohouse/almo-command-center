export default function Forecasting() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-black text-primary">Forecasting</h2>
      ...
      <div className="glass-card p-12 flex flex-col items-center justify-center gap-4 text-center">
        <span className="material-symbols-outlined text-[48px] text-on-surface-variant/40">show_chart</span>
        <div>
          <div className="text-sm font-semibold text-primary/60">Forecasting</div>
